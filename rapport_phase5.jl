...
# ╔═╡ 5fffde30-63d8-410e-a9e6-a97019b7fb9d
begin
    using PlutoUI,Plots,Printf,Random
	using FileIO, Images, ImageView, ImageMagick
    include("projet/phase5/node.jl")
    include("projet/phase5/edge.jl")
    include("projet/phase5/read_stsp.jl")
    include("projet/phase5/graph.jl")
    include("projet/phase5/mst_kruskal.jl")
    include("projet/phase5/mst_prim.jl")
    include("projet/phase5/tsp_rsl.jl")
    include("projet/phase5/tsp_hk.jl")
    include("projet/phase5/tsp.jl")
    include("projet/phase5/im_recons.jl")
    include("projet/phase5/tests/test_node.jl")
    include("projet/phase5/tests/test_edge.jl")
    include("projet/phase5/tests/test_graph.jl")
    include("projet/phase5/tests/test_mst_kruskal.jl")
    include("projet/phase5/tests/test_mst_prim.jl")
    include("projet/phase5/tests/test_tsp_rsl.jl")
    include("projet/phase5/tests/test_tsp_hk.jl")
    include("shredder-julia/bin/tools.jl")
end

# ╔═╡ 45537ad0-5556-11ec-1287-03a4acff7b6f
md"
# MTH6412B: Projet Voyageur de Commerce
## Phase 5: Reconstruction d'images
* **Auteur**: El Hadji Abdou Aziz Ndiaye (1879468)
* **Code source**: [Repertoire Github](https://github.com/elazizndiaye/mth6412b-starter-code/tree/phase5)
"

# ╔═╡ 0c63f771-92b5-400b-95cf-312b6dd58159
md"
## Importation du code
"
...
md"
La reconstruction des images se fait en utilisant directement les algorithmes de RSL et de HK.

Pour l'algorithme de RSL, les poids des arêtes reliées au noeud zéro ont été ajustés pour éviter d'avoir un arbre de recouvrement trivial.

Dans certains cas, le tour a été inversé (grâce à la fonction `inverse_tour` pour obtenir des résultats fidèles avec les images originaux.

L'ensemble des résultats ci-dessous peuvent être obtenu en lancant le programme principal.
"
...
load("shredder-julia/images/original/abstract-light-painting.png")
...
load("projet/phase5/reconstructed_images/images/abstract-light-painting.rsl.png")
